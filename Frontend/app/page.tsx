...
export default function Dashboard() {
  ...
  return (
    <div className="relative min-h-full w-full">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-10 py-6">
        {/* Institutional Hero Section */}
        <div className="-mt-4 mb-6 relative flex items-center justify-center gap-8 max-w-5xl mx-auto w-full">
           <div className="h-[3px] flex-1 bg-gradient-to-r from-transparent via-slate-400 to-slate-700 rounded-full opacity-70"></div>
           <img 
               src="/janneeti-logo.png" 
               alt="JanNeeti Logo" 
               className="h-20 md:h-24 object-contain" 
           />
           <div className="h-[3px] flex-1 bg-gradient-to-l from-transparent via-slate-400 to-slate-700 rounded-full opacity-70"></div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <KPICard
            title="IN PROGRESS"
            value={summary ? (summary.in_progress + summary.partial) : (isLoading ? '…' : 0)}
            variant="warning"
          />
          <KPICard
            title="NO PROGRESS"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="group p-5 rounded-2xl border border-indigo-200/50 bg-gradient-to-br from-indigo-500/5 to-blue-500/5 backdrop-blur-md shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-[10px] font-black tracking-[0.15em] text-slate-700 uppercase">Policy Coverage</p>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-3xl font-black tracking-tighter text-indigo-700">{accountability.policy_coverage_pct}%</span>
              </div>
              <p className="text-[10px] mt-2 text-slate-700 font-bold uppercase tracking-wider">
            ...
            <div className="group p-5 rounded-2xl border border-emerald-200/50 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 backdrop-blur-md shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-[10px] font-black tracking-[0.15em] text-slate-700 uppercase">Bills Passed</p>
              </div>
              <div className="flex items-baseline gap-2">
            ...
            <div className="group p-5 rounded-2xl border border-amber-200/50 bg-gradient-to-br from-amber-500/5 to-orange-500/5 backdrop-blur-md shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-[10px] font-black tracking-[0.15em] text-slate-700 uppercase">Fulfillment Rate</p>
              </div>
              <div className="flex items-baseline gap-2">
        ...
        <div className="mt-16">
          <div className="flex items-center justify-between mb-8">
            <div className="flex flex-col">
              ...
              <p className="text-[10px] text-slate-700 font-bold uppercase tracking-[0.2em] mt-1">Live updates from the Parliament of India</p>
            </div>
            <div className="flex items-center gap-2">
              <div className="px-3 py-1 bg-white/60 backdrop-blur-sm border border-slate-300 rounded-full text-[10px] font-black text-slate-700">
          ...
          <div className="grid grid-cols-1 gap-3">
            {recent && recent.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-5">
                    <div className="flex flex-col items-center justify-center w-12 h-12 rounded-lg bg-slate-100 group-hover:bg-indigo-50 transition-colors">
                      <span className="text-[10px] font-black text-slate-600 group-hover:text-indigo-600 uppercase leading-none mb-1">FY</span>
                      <span className="text-sm font-black text-slate-800 group-hover:text-indigo-800 leading-none">{update.year}</span>
                    </div>
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <Badge variant="outline" className="text-[9px] font-black uppercase tracking-widest border-slate-300 text-slate-700 bg-slate-100">{update.event_type}</Badge>
                        <span className="h-1 w-1 rounded-full bg-slate-400" />
                        <span className="text-[10px] font-bold text-slate-600">Verified Activity</span>
                      </div>
                      <h3 className="font-bold text-[14px] text-slate-900 tracking-tight group-hover:text-indigo-900 transition-colors">{update.policy_name}</h3>
                    </div>
                  </div>
              ...
              <div className="text-center py-16 border-2 border-dashed border-slate-300 rounded-2xl bg-slate-50/50">
                <p className="text-sm text-slate-600 font-bold uppercase tracking-widest">No recent administrative pulses detected</p>
              </div>
            )}
          </div>
        </div>
